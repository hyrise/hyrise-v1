...
const hyrise::storage::dict_ptr_t & TableRangeView::dictionaryAt(const size_t column, const size_t row, const table_id_t table_id , const bool of_delta) const{
  size_t actual_row;
  actual_row = row + _start;
...
const hyrise::storage::dict_ptr_t & TableRangeView::dictionaryByTableId(const size_t column, const table_id_t table_id) const{
  return _table->dictionaryByTableId(column, table_id);
}

void TableRangeView::setDictionaryAt(hyrise::storage::dict_ptr_t dict, const size_t column, const size_t row, const table_id_t table_id){
