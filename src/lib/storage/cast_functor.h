...
struct cast_functor_by_value_id {
  ...
  hyrise::storage::DCMutableTable *table;
  size_t column;
  ValueId vid;

  cast_functor_by_value_id(hyrise::storage::DCMutableTable *t, const size_t f, const ValueId v): table(t), column(f), vid(v) {}
...
struct cast_functor_by_row {
  ...
  cast_functor_by_row(hyrise::storage::DCMutableTable *t, const size_t f, const size_t r): table(t), column(f), row(r) {}
