...
void PointerCalculator::print(std::ostream& outStream, const std::string tableName, const size_t limit) const {
  PrettyPrinter::print(this, tableName, outStream, limit);
}
