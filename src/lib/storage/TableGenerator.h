...
class TableGenerator {
  ...
  */
  ...
  atable_ptr_t int_offset(size_t rows,
                          size_t cols,
                          size_t offset1,
                          size_t offset2,
                          size_t offset2_start,
                          size_t factor,
                          int big_value_at_end = -1);

  atable_ptr_t int_offset_delta(size_t rows,
                                size_t cols,
                                size_t offset1,
                                size_t offset2,
                                size_t offset2_start,
  ...
  atable_ptr_t create_empty_table_modifiable(size_t rows,
                                             size_t cols,
                                             std::vector<std::string> name = std::vector<std::string>());
  ...
  std::vector<atable_ptr_t> one_column_main_delta(size_t rows_main,
                                                  size_t rows_delta,
  ...
  std::vector<atable_ptr_t> value_order_successively(size_t rows_main,
                                                     size_t rows_delta,
                                                     size_t dict_size_main,
                                                     size_t dict_size_delta,
                                                     size_t intersection,
