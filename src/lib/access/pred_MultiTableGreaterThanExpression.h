#ifndef SRC_LIB_ACCESS_PRED_MULTITABLEGREATERTHANEXPRESSION_H_
#define SRC_LIB_ACCESS_PRED_MULTITABLEGREATERTHANEXPRESSION_H_

template <typename T>
class MultiTableGreaterThanExpression: public SimpleFieldExpression {
 ...
 public:
  ...
  MultiTableGreaterThanExpression(size_t i, field_t f, T _value):
      SimpleFieldExpression(i, f), value(_value)
  {}

  MultiTableGreaterThanExpression(size_t i, field_name_t f, T _value):
      SimpleFieldExpression(i, f), value(_value)
  {}


  MultiTableGreaterThanExpression(hyrise::storage::c_store_ptr_t _table, field_t _field, T _value):
...
#endif  // SRC_LIB_ACCESS_PRED_MULTITABLEGREATERTHANEXPRESSION_H_
