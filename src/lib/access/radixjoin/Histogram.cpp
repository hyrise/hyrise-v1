...
const std::string Histogram::vname() { return "Histogram"; }

void Histogram::setPart(const size_t p) { _part = p; }

void Histogram::setCount(const size_t c) { _count = c; }

void Histogram::setBits(const uint32_t b, const uint32_t sig) {
  _bits = b;
  _significantOffset = sig;
}

void Histogram::setBits2(const uint32_t b, const uint32_t sig) {
  _bits2 = b;
  _significantOffset2 = sig;
}

uint32_t Histogram::bits() const { return _bits; }

uint32_t Histogram::significantOffset() const { return _significantOffset; }
...
const std::string Histogram2ndPass::vname() { return "Histogram2ndPass"; }
}
}
