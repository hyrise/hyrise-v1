...
const std::string MergeHashTables::vname() { return "MergeHashTables"; }

void MergeHashTables::setKey(const std::string& key) { _key = key; }

const std::string MergeHashTables::getKey() const { return _key; }
}
}
