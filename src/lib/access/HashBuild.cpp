...
const std::string HashBuild::vname() { return "HashBuild"; }

void HashBuild::setKey(const std::string& key) { _key = key; }

const std::string HashBuild::getKey() const { return _key; }
}
}
