...
class QueryTransformationEngine {
  ...
  void applyParallelizationTo(Json::Value& operatorConfiguration,
                              const std::string& operatorId,
                              Json::Value& query) const;

  //  Builds an operators parallel instances to arrange them in the query.
  std::vector<std::string>* buildInstances(Json::Value& query,
  ...
  Json::Value nextInstanceOf(Json::Value& operatorConfiguration,
                             const std::string& operatorId,
  ...
  void replaceOperatorWithInstances(const std::string& operatorId,
  ...
  void appendInstancesDstNodeEdges(const std::string& operatorId,
                                   const std::vector<std::string>& instanceIds,
                                   Json::Value& query,
                                   const size_t numberOfInitialEdges) const;
  ...
  /*  For all edges where the original operator is the source node,
      ...
      operator. */
  void appendConsolidateSrcNodeEdges(const std::string& operatorId,
                                     const std::vector<std::string>& instanceIds,
                                     const std::string& unionOperatorId,
                                     Json::Value& query,
                                     const size_t numberOfInitialEdges) const;
  ...
  void removeOperatorNodes(Json::Value& query, const Json::Value& operatorId) const;
  ...
  std::string instanceIdFor(const std::string operatorId, const size_t instanceId) const;
