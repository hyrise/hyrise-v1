...
const std::string SettingsOperation::vname() { return "SettingsOperation"; }

void SettingsOperation::setThreadpoolSize(const size_t newSize) { _threadpoolSize = newSize; }
}
}
