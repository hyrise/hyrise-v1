...
DEFINE_EXPRESSION_CLASS(Store_FLV_F1_LTEQ_INT, ((f1)(hyrise_int_t)(>= )(asUInt64)), ());
...
DEFINE_EXPRESSION_CLASS(Store_FLV_F1_EQ_INT32_OR_F2_NEQ_FLOAT,
                        ...
                        ()(|| ));
DEFINE_EXPRESSION_CLASS(Store_FLV_F1_EQ_STRING_AND_F2_GT_INT,
                        ((f1)(hyrise_string_t)(== )(asString))((f2)(hyrise_int_t)(< )(asInt)),
                        ()(&&));
