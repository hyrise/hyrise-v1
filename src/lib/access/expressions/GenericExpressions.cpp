...
REGISTER_EXPRESSION_CLASS(Store_FLV_PT_F1_EQ_INT);
REGISTER_EXPRESSION_CLASS(Store_FLV_PT_F1_NEQ_INT);
REGISTER_EXPRESSION_CLASS(Store_FLV_PT_F1_LT_INT);

REGISTER_EXPRESSION_CLASS(Store_FLV_F1_EQ_INT_AND_F2_EQ_INT);
REGISTER_EXPRESSION_CLASS(Store_FLV_PT_F1_EQ_INT_AND_F2_EQ_INT);
...
REGISTER_EXPRESSION_CLASS(Store_FLV_F1_EQ_STRING_AND_F2_GT_INT);
}
}
