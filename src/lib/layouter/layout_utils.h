...
// Copy Helper
std::vector<hyrise::layouter::subset_t>& operator+=(std::vector<hyrise::layouter::subset_t>& a,
                                                    const std::vector<hyrise::layouter::subset_t>& b);
std::vector<hyrise::layouter::subset_t> operator+(const std::vector<hyrise::layouter::subset_t>& a,
                                                  const std::vector<hyrise::layouter::subset_t>& b);

bool operator==(const std::vector<hyrise::layouter::subset_t>& left,
                const std::vector<hyrise::layouter::subset_t>& right);
bool operator!=(const std::vector<hyrise::layouter::subset_t>& left,
                const std::vector<hyrise::layouter::subset_t>& right);
