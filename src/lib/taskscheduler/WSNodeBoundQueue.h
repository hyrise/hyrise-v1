...
template<class QUEUE> class WSNodeBoundQueue;
...
public:
  WSNodeBoundQueue(WSThreadLevelQueuesScheduler<QUEUE> * scheduler, size_t core, size_t threads): ThreadLevelQueue<QUEUE>(threads), WSThreadLevelQueue<QUEUE>(scheduler, threads), NodeBoundQueue<QUEUE>(core, threads) {}
  ~WSNodeBoundQueue(){}
