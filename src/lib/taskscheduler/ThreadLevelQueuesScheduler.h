...
template<class QUEUE> class ThreadLevelQueuesScheduler;
...
template <class QUEUE>
log4cxx::LoggerPtr ThreadLevelQueuesScheduler<QUEUE>::_logger = log4cxx::Logger::getLogger("taskscheduler.ThreadLevelQueuesScheduler");
