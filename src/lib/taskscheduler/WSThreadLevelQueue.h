...
template<class QUEUE> class WSThreadLevelQueue;
...
public:
  WSThreadLevelQueue(WSThreadLevelQueuesScheduler<QUEUE> * scheduler, size_t threads): ThreadLevelQueue<QUEUE>(threads), _scheduler(scheduler) {}
  ~WSThreadLevelQueue(){}
