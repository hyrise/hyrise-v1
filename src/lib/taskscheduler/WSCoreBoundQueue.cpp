...
WSCoreBoundQueue::WSCoreBoundQueue(int core, WSCoreBoundQueuesScheduler* scheduler)
    : AbstractCoreBoundQueue(core), _scheduler(scheduler) {}

void WSCoreBoundQueue::init() { launchThread(_core); }
