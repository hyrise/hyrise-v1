...
template<class QUEUE> class WSNodeBoundQueuesScheduler;
...
public:
	WSNodeBoundQueuesScheduler(int queues): ThreadLevelQueuesScheduler<QUEUE>(queues), WSThreadLevelQueuesScheduler<QUEUE>(queues), NodeBoundQueuesScheduler<QUEUE>(queues){};
