...
template<class QUEUE> class WSCoreBoundQueuesScheduler;
...
public:
	WSCoreBoundQueuesScheduler(int queues): ThreadLevelQueuesScheduler<QUEUE>(queues), WSThreadLevelQueuesScheduler<QUEUE>(queues), CoreBoundQueuesScheduler<QUEUE>(queues){};
