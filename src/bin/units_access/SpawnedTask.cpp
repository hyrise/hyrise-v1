...
std::shared_ptr<PlanOperation> SpawnedTask::parse(const Json::Value& data) { return std::make_shared<SpawnedTask>(); }

const std::string SpawnedTask::vname() { return "SpawnedTask"; }
}
}
