...
void SpawnParallelSubtasks::setNumberOfSpawns(const size_t number) { m_numberOfSpawns = number; }
...
const std::string SpawnParallelSubtasks::vname() { return "SpawnParallelSubtasks"; }
}
}
