...
void TpccExecuteTest::doDelivery(int w_id, int d_id, int o_carrier_id, std::string date) {
...
void TpccExecuteTest::doOrderStatus(int w_id, int d_id, int c_id, std::string c_last) {
...
void TpccExecuteTest::doPayment(int w_id, int d_id, int c_id, std::string c_last, int c_w_id, int c_d_id, bool bc_customer, std::string date) {
...
void TpccExecuteTest::doStockLevel(int w_id, int d_id, int threshold) {
