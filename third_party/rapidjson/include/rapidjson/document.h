...
public:
	...
	*/
	...
	GenericValue(const Ch* s, SizeType length) { 
        ...
        GenericValue(const std::string& s) {
          SetString(s.c_str(), s.size());
        }
	...
	*/
	GenericValue& operator[](const Ch* name) {
        ...
        GenericValue& operator[](const std::string& name) {
	...
	const GenericValue& operator[](const Ch* name) const { return const_cast<GenericValue&>(*this)[name]; }
        ...
        // Wrapper of String
        const GenericValue& operator[](const std::string& name) const {
          return (*this)[name.c_str()];
        }
	...
	MemberIterator MemberEnd()				{ RAPIDJSON_ASSERT(IsObject()); return data_.o.members + data_.o.size; }
        ...
        //! Returns the list of members in this object
        std::vector<std::string> getMemberNames() const { 
          std::vector<std::string> result;
          RAPIDJSON_ASSERT(IsObject());
          for(ConstMemberIterator it = MemberBegin(); it != MemberEnd(); it++) {
	...
	*/
	bool HasMember(const Ch* name) const { return FindMember(name) != 0; }
        bool isMember(const Ch* name) const { return HasMember(name);}
...
\endcode
	...
	*/
	...
	int GetInt() const			{ RAPIDJSON_ASSERT(flags_ & kIntFlag);   return data_.n.i.i;   }
        int asInt() const { return GetInt(); }

	unsigned GetUint() const	{ RAPIDJSON_ASSERT(flags_ & kUintFlag);  return data_.n.u.u;   }
        unsigned asUInt() const { return GetUint(); }
        
	int64_t GetInt64() const	{ RAPIDJSON_ASSERT(flags_ & kInt64Flag); return data_.n.i64; }
        int64_t asInt64() const { return GetInt64(); }
	uint64_t GetUint64() const	{ RAPIDJSON_ASSERT(flags_ & kUint64Flag); return data_.n.u64; }
        uint64_t asUInt64() const { return GetUint64(); }
	...
	double GetDouble() const {
        ...
        double asDouble() const { return GetDouble(); }
        float asFloat() const { return static_cast<float>(GetDouble()); }
	...
	const Ch* GetString() const { RAPIDJSON_ASSERT(IsString()); return data_.s.str; }
        ...
        const std::string asString() const { return std::string(GetString()); }
