...
apt-get -y install build-essential wget bzip2 ccache cmake git liblog4cxx10v5 liblog4cxx10-dev libmysqlclient-dev libunwind8-dev libev-dev libtbb-dev libboost-all-dev libhwloc-dev binutils-dev libgoogle-perftools-dev  gfortran curl git
